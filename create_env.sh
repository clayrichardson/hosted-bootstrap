...
export RESOURCE_GROUP_NAME=${ENVIRONMENT}-rg
export JUMPBOX1_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}jumpbox1
export BOSH_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}bosh
export CONCOURSE_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}concourse
export CONCOURSE_WORKERS_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}concourselrs
export MYSQLSA_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}mysqlsa
export CF_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}cf
export DIEGO_STORAGE_ACCOUNT_NAME=${ENVIRONMENT}diego
